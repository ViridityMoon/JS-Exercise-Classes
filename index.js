...
const newPerson = new Person('Noah', 21);
...
class Car {
  ...
  drive(miles){
    let max = miles/this.milesPerGallon
    if (this.tank >= max){
      this.odometer += miles;
      this.tank -= max;
    } else if (this.tank <= max){
...
const newLambdasian = new Lambdasian({name: 'Noah', age: 21, location: 'Indiana'});
...
class Instructor extends Lambdasian{
  constructor({specialty, favLanguage, catchPhrase, name, age, location}){
...
class Student extends Lambdasian{
  constructor({previousBackground, className, favSubjects, name, age, location}){
    super({name, age, location})
